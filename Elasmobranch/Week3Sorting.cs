...
{
    public static class Week3Sorting
    {
        /// <summary>
        ...
        private static IComparable MyMin(List<IComparable> li)
        {
            ...
            foreach (var i in li)
            {
                if (i.CompareTo(minimum) < 0) minimum = i;
            }
        ...
        private static List<IComparable> CustomSortPositiveNegative(List<IComparable> l)
        {
            ...
            List<IComparable> liNegative = new List<IComparable>();
            List<IComparable> liPositive = new List<IComparable>();
        ...
        /// </summary>
        /// <param name="l">The list to sort</param>
        public static List<IComparable> QuickSort(List<IComparable> l)
        {
            ...
            if (l.Count < 4)
            {
                return CustomSortPositiveNegative(l);
            }
