    ...
    public static class Week5Encryption
    {
        ...
        public class RivestShamirAdleman
        {
            ...
            public RivestShamirAdleman()
            {
                ...
                do primes = GenerateRandomPrimes(2); while (primes[0] == primes[1]);
                ...
                var publicKey = new BigInteger(3); while (GreatestCommonDivisor(publicKey, carmichaelLambda) != 1) publicKey += 2;
            ...
            /// <remarks>We had to resort to BigInteger here otherwise even very small values easily overflowed,
            /// making my life very difficult. BigInteger kindly provides a wonderful method for finding the
            /// result of modular exponentiation efficiently. I was overjoyed.</remarks>
            ...
            public static List<BigInteger> GenerateListOfPrimes(int limit)
            {
                ...
                {
                    if (bits[i]) primes.Add(new BigInteger(i));
                }
            ...
            private static List<BigInteger> GenerateRandomPrimes(int numberOfPrimes, int rangeStart = 1000, int rangeEnd = 10000)
            {
                ...
                {
                    randomPrimes.Add(primes[random.Next(primes.Count)]);
                }
